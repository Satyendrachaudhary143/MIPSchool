...
const TeacherAccount = () => {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Teacher Account Overview</h2>
      ...
      <div className="bg-gray-50 p-4 md:p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
          <div className="bg-white p-3 md:p-4 rounded-md shadow-sm">
            ...
            <p className="text-base md:text-lg font-medium text-gray-900">Teacher Name</p>
          </div>
          <div className="bg-white p-3 md:p-4 rounded-md shadow-sm">
            <p className="text-sm md:text-base text-gray-600">Email</p>
            <p className="text-base md:text-lg font-medium text-gray-900">teacher@example.com</p>
          </div>
          <div className="bg-white p-3 md:p-4 rounded-md shadow-sm">
            <p className="text-sm md:text-base text-gray-600">Mobile</p>
            <p className="text-base md:text-lg font-medium text-gray-900">987-654-3210</p>
          </div>
          <div className="bg-white p-3 md:p-4 rounded-md shadow-sm">
            <p className="text-sm md:text-base text-gray-600">Class Teacher of</p>
